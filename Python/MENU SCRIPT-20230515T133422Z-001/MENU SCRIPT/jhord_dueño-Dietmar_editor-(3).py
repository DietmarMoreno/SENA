...
while True:
    try:#agredado la funcion try
        ...
        #se elimino los si o no de aqui para que quede una linea mas corta
        if (menu=="1") or (menu=="2") or (menu=="3") or (menu=="4") or (menu=="5") or (menu=="6"):
            try: 
                mix(v1=int(input("ingrese el primer numero:\n")), v2=int(input("ingrese el segudo numero:\n")),menus=str(menu))
            except(ZeroDivisionError,NameError): #se agrego el error del cero para que vuelva al menu
                print("error")
        else:
           print("el numero no esta dentro del rango")
#fin de lineas de codigo