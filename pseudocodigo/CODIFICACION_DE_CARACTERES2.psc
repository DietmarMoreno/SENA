Algoritmo CODIFICACION_DE_CARACTERES
	...
	Escribir "DESEA CODIFICAR?"
	Escribir "1. COMBINADO"
	Escribir "2. CODIFICADO"
	Escribir "3. DESCODIFICAR"
	LEER RES
		...
		Segun RES Hacer
			...
			3:
				...
				Para I<-0 Hasta 25-1 Con Paso 1 Hacer
					Para J<-0 Hasta 25-1 Con Paso 1 Hacer
						Mientras PACO[I]=N1[J] Hacer
							PACO[I]=N[J]
						Fin Mientras
					Fin Para
				Fin Para
				Para I<-0 Hasta 25-1 Con Paso 1 Hacer
					Escribir "[" PACO[I] "]"Sin Saltar
				Fin Para
				Escribir ""
			De Otro Modo:
				Escribir "SALIR"
